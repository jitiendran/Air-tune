...
<head>
    ...
    <title>Air tunes | admin</title>
    <link rel="stylesheet" href="//use.fontawesome.com/releases/v5.0.7/css/all.css">
    <link rel="stylesheet" href="admin-sylesheets/admin.css">
</head>
<body>
            ...
            <main>
                    <div class="cards-container">
                        <div class="card1-container">
                            <div class="card1-title-content">
                                <div class="icon-container">
                                    <img src="admin-images/users.png" alt="users">
                                </div>
                            ...
                            <hr>
                            <div class="card1-footer-content">
                                <a href="admin-users.php"><i class="fas fa-edit"></i> Click here to edit users</a>
                            </div>
                        </div>
                        <div class="card1-container">
                            <div class="card1-title-content">
                                <div class="icon-container">
                                    <img src="admin-images/albums.png" alt="albums">
                                </div>
                                <div class="text-container">
                                    <h2>No of albums</h2>
                                    <h3>10</h3>
                            ...
                            <hr>
                            <div class="card1-footer-content">
                                <a href="#"><i class="fas fa-edit"></i> Click here to edit albums</a>
                            </div>
                        </div>
                        <div class="card1-container">
                            <div class="card1-title-content">
                                <div class="icon-container">
                                    <img src="admin-images/songs.gif" alt="users">
                                </div>
                                <div class="text-container">
                                    <h2>No of songs added</h2>
                                    <h3>256</h3>
                                </div>
                            </div>
                            <hr>
                            <div class="card1-footer-content">
                                <a href="#"><i class="fas fa-edit"></i> Click here to edit songs</a>
                            </div>
                        </div>
                    </div>
            </main>
