            ...
            <main>
                    ...
                    for($i = 1 ; $i <= $count ;$i++){
                        ...
                        echo "<div class='song-wrapper'>";
                            echo "<div class='song-content'>";
                                ...
                                echo "<button id='play' onclick='play_audio()' ><i class='far fa-play-circle'></i></button>";
                                echo "<button id='pause' onclick='play_audio()' ><i class='far fa-pause-circle'></i></button>";
                                echo "</div>";
                ...
                <!-- <div class="song-wrapper">
                    <div class="song-content">
                        <p>1. </p>
                        <button id="play" ><i class="far fa-play-circle"></i></button>
                        <p>Boomi Boomi - <span> Ar rahman</span></p>
                    </div>
